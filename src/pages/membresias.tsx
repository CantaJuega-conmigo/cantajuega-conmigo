...
export default function Membresias( ) {
   ...
   const images = [firstbackground, secondbackground, firstbackground, secondbackground];
   const colors = ['#f08d0d', '#39a1bb', '#5e139c', '#eb2f06'];
    ...
    <main>
      <header>
        <div className="h-60 bg-[#fada4d]">
          <div
            className="w-full h-full bg-cover lg:bg-center flex justify-center items-center"
            style={{
              backgroundImage:
        ...
        <div className="px-4">
          ...
          <div className="flex flex-col gap-y-6 lg:flex-row lg:gap-x-3 lg:max-w-7xl lg:mx-auto">
              ...
              <div className="bg-white h-[85%] rounded-b-2xl p-3 text-gray-500 flex flex-col justify-between items-center">
                <div>
                  <p className="text-base py-2 border-b-2 border-dashed border-gray-400">
                    Todas las herramientas terapéuticas para niñas y niños de 0
                    a 6 años.
                  </p>
                  <p className="text-base py-2 border-b-2 border-dashed border-gray-400">
            ...
            <article className="bg-[#39a1bb] p-1 rounded-2xl h-96 lg:basis-1/4">
              ...
              <div className="bg-white h-[85%] rounded-b-2xl p-3 text-gray-500 flex flex-col justify-between items-center">
                <div>
                  ...
                  <p className="text-lg py-2 ">
                    Precio: <b>Q199.99 cada 6 meses</b>.
                  </p>
                </div>
                <div>
                  <button className="bg-blue text-white p-3 font-semibold rounded-xl w-60">
            ...
            <article className="bg-[#eb2f06] p-1 rounded-2xl h-96 lg:basis-1/4">
              <header className=" w-11/12 mx-auto h-14 flex items-end justify-between">
                <h1 className="font-[Kidz] text-4xl text-white">
                  CANTA CONMIGO
                </h1>
                <Image height={100} width={100} src={secondbackground} alt="" />
              </header>
              ...
              <div className="bg-white h-[85%] rounded-b-2xl p-3 text-gray-500 flex flex-col justify-between items-center">
                <div>
                  ...
                  <p className="text-base py-2 border-b-2 border-dashed border-gray-400">
                    Cancioneros digitales disponibles.
                  </p>
                  <p className="text-lg py-2 ">
                    Precio: <b>Q99.99 cada 6 meses</b>.
                  </p>
                </div>
                <div>
                  <button className="bg-blue text-white p-3 font-semibold rounded-xl w-60">
      ...
      <footer className="bg-[#fdc273] lg:h-60">
        <div
          className="p-8 my-8 bg-cover bg-top lg:bg-center lg:h-full flex items-center"
